...
public class MojitoObject extends MojitoLocalObject {
    ...
    public MojitoObject(int id, String name, boolean hasExtras, String type, float price, int extras) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        MojitoObject that = (MojitoObject) o;
