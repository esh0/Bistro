...
public abstract class AbstractBillValueChangeableAdapter<T extends MojitoObject>
    ...
    public void onBindViewHolder(BillDiscountViewHolder holder, int position) {
        ...
        if (entry.isNew() || entry.isModified()) {
            ...
            holder.valueTextView.setTextColor(ContextCompat.getColor(context, R.color.colorAccent));
