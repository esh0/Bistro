...
import pl.sportdata.mojito.entities.base.MojitoObjectUtils;
...
public class BillEditionActivityImpl extends BillEditionActivity
        ...
        SplitBillsDialogFragment.Listener {
    ...
    private MojitoObject editedObject;
    ...
    @Override
    public void showEditTableNumber(int current) {
        NumberInputDialogFragment f = NumberInputDialogFragment
                .newInstance(getString(R.string.table_number), String.valueOf(current), getString(R.string.accept), getString(R.string.cancel));
        f.show(getSupportFragmentManager(), EDIT_TABLE_NUMBER_TAG);
    }
    ...
    public void onPositiveButtonClicked(String value, String numberInputFragmentTag) {
        switch (numberInputFragmentTag) {
            ...
            case EDIT_TABLE_NUMBER_TAG:
                ...
                presenter.onTableNumberChanged(number);
                break;
    ...
    public void onMarkupSelected(Markup markup) {
        if (MojitoObjectUtils.isOpenPriceType(markup)) {
    ...
    public void onPaymentTypeSelected(PaymentType paymentType) {
        if (MojitoObjectUtils.isOpenPriceType(paymentType) || MojitoObjectUtils.isCardType(paymentType)) {
