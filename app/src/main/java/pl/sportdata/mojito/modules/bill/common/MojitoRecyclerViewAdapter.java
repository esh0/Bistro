...
public class MojitoRecyclerViewAdapter<T extends MojitoObject> extends RecyclerView.Adapter<MojitoRecyclerViewAdapter.ViewHolder> {

    private final List<T> values;
    private String pluFormat;
    private AdapterListener<T> listener;

    public MojitoRecyclerViewAdapter(@Nullable List<T> items) {
        if (items != null) {
            values = items;
    ...
    @Override
    public void onBindViewHolder(final MojitoRecyclerViewAdapter.ViewHolder holder, int position) {
    ...
    public interface AdapterListener<T extends MojitoObject> {
