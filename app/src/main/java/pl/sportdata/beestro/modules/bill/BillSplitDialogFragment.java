...
import static pl.sportdata.beestro.entities.bills.BillUtils.BY_GUEST_SPLIT_OPTION;
import static pl.sportdata.beestro.entities.bills.BillUtils.EQUAL_SPLIT_OPTION;
import static pl.sportdata.beestro.entities.bills.BillUtils.NONE;
import static pl.sportdata.beestro.entities.bills.BillUtils.PROPORTION_SPLIT_OPTION;
import static pl.sportdata.beestro.entities.bills.BillUtils.VALUE_SPLIT_OPTION;
...
public class BillSplitDialogFragment extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity(), R.style.BeestroAlertDialogTheme);
