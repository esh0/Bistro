...
public class MainActivityImpl extends BasePresenterActivity
    ...
    @Override
    public void showBillExistsForTable(String tableNumber) {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(this).setTitle(R.string.error)
                .setMessage(String.format(getString(R.string.bill_for_table_exists), tableNumber)).setPositiveButton(R.string.ok, null);
