package pl.sportdata.beestro.entities.entries;

import com.google.gson.annotations.SerializedName;

import java.util.UUID;

import pl.sportdata.beestro.entities.base.BeestroLocalObject;

public class Entry extends BeestroLocalObject {
    ...
    @Override
    public Entry copy() {
        BeestroLocalObject clonedSuper = super.copy();
